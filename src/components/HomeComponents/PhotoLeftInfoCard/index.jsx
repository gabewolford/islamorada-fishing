        ...
        <>
            <div className="fade-in show flex flex-col md:flex-row items-center gap-6 lg:gap-28 order-1 mx-6 lg:mx-20 mb-16">
                ...
                <div className="flex flex-col items-start lg:mr-20">
                    ...
                    <Link to="/guides" className="text-white medium bg-cyan-420 hover:bg-cyan-hover transition duration-300 ease-in-out rounded-3xl px-5 py-3.5 w-fit">Meet Our Guides</Link>
                </div>
            </div>
        </>
    )
