...
export default function PhotoRightInfoCard() {
    ...
    return (
        <>
             <div className="fade-in flex flex-col md:flex-row items-center gap-6 lg:gap-28 mx-6 lg:mx-20 order-1 mb-16">
                <img className="md:w-1/2 md:order-1" src={wwsImage} alt="Bonefish Image" />
                <div className="flex flex-col md:order-0 lg:ml-20">
                    ...
                    <Link to="/explore-islamorada" className="text-white medium bg-cyan-420 hover:bg-cyan-hover transition duration-300 ease-in-out rounded-3xl px-5 py-3.5 w-fit">Explore Islamorada</Link>
                </div>
            </div>
        </>
    )
