            ...
            <footer className="w-full mx-auto bg-cyan-69 absolute bottom-0">
                <div className="flex flex-col justify-center items-center gap-4">
                    ...
                    <div className="absolute px-6 lg:px-44 flex flex-col text-center">
                        ...
                        <Link to="/contact" className="text-cyan-420 medium bg-white hover:bg-cyan-hover hover:text-white transition duration-300 ease-in-out rounded-3xl px-5 py-3.5 block w-fit mx-auto">Contact Us</Link>
                    </div>
                </div>
