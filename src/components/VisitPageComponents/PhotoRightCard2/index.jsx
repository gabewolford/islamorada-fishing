        ...
        <>
            <div className="flex flex-col md:flex-row items-center gap-6 lg:gap-28 order-1 mb-16">
                ...
                <div className="flex flex-col md:order-0 lg:ml-20">
                    ...
                    <Link to="/partners/stay" className="text-white font-medium bg-cyan-420 hover:bg-cyan-hover transition duration-300 ease-in-out rounded-3xl px-5 py-3.5 w-fit">Where To Stay</Link>
                </div>
            </div>
        </>
    )
