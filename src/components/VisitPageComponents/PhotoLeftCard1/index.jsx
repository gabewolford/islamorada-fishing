        ...
        <>
            <div className="flex flex-col md:flex-row items-center gap-6 lg:gap-28 order-1 mb-0 md:mb-16">
                ...
                <div className="flex flex-col items-start lg:mr-20">
                    ...
                    <p className="text-base md:text-lg font-bold mb-4">Departure point:</p>
                    <p className="text-base md:text-lg">81576 Overseas Hwy</p>
                    <p className="text-base md:text-lg mb-4">Islamorada, FL 33036</p>
                    <Link to="https://goo.gl/maps/cnpM2RB43WTB36Lz6?coh=178573&entry=tt" target="_blank" className="text-white font-medium bg-cyan-420 hover:bg-cyan-hover transition duration-300 ease-in-out rounded-3xl px-5 py-3.5 w-fit mb-8">Map</Link>
                </div>
            </div>
