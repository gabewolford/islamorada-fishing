        ...
        <>
            <div className="fade-in show flex flex-col md:flex-row items-center gap-6 lg:gap-28 order-1 mb-0 md:mb-16">
                ...
                <div className="flex flex-col items-start lg:mr-20">
                    ...
                    <Link to="https://goo.gl/maps/cnpM2RB43WTB36Lz6?coh=178573&entry=tt" target="_blank" className="text-white medium bg-cyan-420 hover:bg-cyan-hover transition duration-300 ease-in-out rounded-3xl px-5 py-3.5 w-fit mb-8">Directions</Link>
                </div>
            </div>
