        ...
        <>
            <div className="fade-in flex flex-col md:flex-row items-center gap-6 lg:gap-28 order-1 mb-16">
                ...
                <div className="flex flex-col md:order-0 lg:ml-20">
                    <h4 className="text-2xl md:text-3xl medium leading-7 mb-4 ">Bonefishing on the Flats</h4>
                    <p className="text-sm md:text-base mb-4">Stalk or hunt across the shallow flats with your guide for the elusive bonefish. Also known as the “Grey Ghost”, this tough catch is one of the most sought-after challenges for anglers. Bonefishing is year-round in the Florida Keys.</p>
